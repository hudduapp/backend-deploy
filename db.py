...
# 1 get new code
clone_command = f"sudo git clone --single-branch --branch {data['git_branch']} {data['git_user']}:{data['git_password']}@{data['git_repository']} {app_dir}"
os.system(clone_command)

# 2 build with nixpacks
nixpacks_command = "sudo nixpacks build "
